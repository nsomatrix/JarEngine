...
/**
 * Proxy-enabled HTTP connection wrapper
 * Routes HTTP connections through configured proxy
 */
public class ProxyConnection extends Connection {
    ...
    public javax.microedition.io.Connection openConnection(String name, int mode, boolean timeouts) throws IOException {
        ...
        if (proxyConfig.isEnabled() && proxyConfig.isHttpEnabled()) {
            cn = url.openConnection(proxyConfig.getHttpProxy());
        } else {
