...
import org.je.device.impl.FontManagerImpl;
...
public class J2SEFontManager implements FontManagerImpl
{
	...
	org.je.device.impl.Font getFont(Font meFont)
	{
    	int key = 0;
    	key |= meFont.getFace();
    	key |= meFont.getStyle();
    	...
    	org.je.device.impl.Font result = (org.je.device.impl.Font) fonts.get(new Integer(key));
	...
	public void setFont(String face, String style, String size, org.je.device.impl.Font font) {
		int key = 0;
	...
	public org.je.device.impl.Font createSystemFont(String defName, String defStyle, int defSize, boolean antialiasing) {
		return new J2SESystemFont(defName, defStyle, defSize, antialiasing);
	}

	public org.je.device.impl.Font createTrueTypeFont(URL defUrl, String defStyle, int defSize, boolean antialiasing) {
